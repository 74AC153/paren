...
char *fmt_u64(char buf[static 17], uint64_t val); /* hex */
char *fmt_u64d(char buf[static 21], uint64_t val); /* dec */
char *fmt_ptr(char buf[static 17], void *val); /* hex */
char *fmt_s64(char buf[static 21], int64_t val); /* dec */
